...
// $qabul_off = true;
$oqishni_kochirish_off = true;
$ikkinchi_mutaxassislik_off = true;
    ...
    if (!empty($imtihondan_otkan_talaba["id"])) {
        ...
        if (!$error) {
            ...
            $request_id = $db->insert("requests", [
                ...
                "firm_id" => $agent_id ? $agent_id : null
            ]);
        }
    ...
    <? } else if (!$qabul_off) { ?>
        <div class="container select-reg-type" style="padding-top:160px;padding-bottom:40px;">
            <div class="row justify-content-center cv-row">
                ...
                <a href="<?=$url2[0]?>/<?=$url[0]?>/ikkinchi-mutaxassislik" class="btn btn-success"><?=t("Ikkinchi mutaxassislik")?></a>
            </div>
        </div>
    <? } else { ?>
        <div class="container" style="padding-top:110px;">
