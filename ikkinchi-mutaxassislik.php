        ...
        <div class="row justify-content-center cv-row">
            <div class="col-11 col-sm-10 col-md-8 col-lg-7 col-xl-6 text-center p-0 mt-3 mb-2">
                <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                    <h1 id="heading text-danger"><?=t("Tez kunda ikkinchi mutaxassislik bo'yicha qabul ochiladi!")?></h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container" style="padding-top:110px;">
        <div class="row justify-content-center cv-row">
            <div class="card px-0 pt-4 pb-0 mt-3 mb-3 text-center">
                ...
                <p><?=t("ikkinchi mutaxassislikka")?></p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 mt-4">
                                ...
                                <div class="col-12">
                                    ...
                                    <? } ?>
                                    <label class="fieldlabels" for="file_3"><?=t("Universitet deplomini yuklang")?> <label class="text-danger">*</label></label>
