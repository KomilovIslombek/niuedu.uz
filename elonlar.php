...
$ads = $db->in_array("SELECT * FROM ads ORDER BY id DESC LIMIT $page_start, $page_count");
$new_count = $db->assoc("SELECT COUNT(*) FROM ads")["COUNT(*)"];
?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xxl-12 col-xl-12 col-lg-12">
                    <div class="row">
                        <h1 class="text-center mb-4 text-dark"><?=translate("Barcha e'lonlar")?></h1>
                            ...
                            <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                                <div class="blog__wrapper">
                                    <div class="blog__item white-bg mb-30 transition-3 fix">
                                        ...
                                        <h3 class="blog__title"><a href="/elon/<?=$post["id"]?>"><?=lng($post["name"])?></a></h3>
                            ...
                            <div class="col-xxl-12">
                                <div class="basic-pagination wow fadeInUp mt-30" data-wow-delay=".2s">
                                    ...
                                    <?
                                        ...
                                        if ($page != 1){
                                            echo '<li class="prev">
                                                    <a href="/ads/'.($page-1).'" class="link-btn link-prev">
                                                        '.translate("Oldingi").'
