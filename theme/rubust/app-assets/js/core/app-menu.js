...
(function(window, document, $) {
  ...
  $.app.menu = {
    ...
    changeLogo: function(menuType){
      var logo = $('.brand-logo');
      if(menuType == 'expand'){
        logo.attr('src',logo.data('expand')).attr("width", "165px");
        logo.attr('src',logo.data('expand')).attr("height", "60px");
        logo.attr('src',logo.data('expand')).css("object-fit", "contain");
      }
      else{
        $(".brand-logo").attr('src',$(".brand-logo").data('expend')).removeAttr("height");
        logo.attr('src',logo.data('collapse')).attr("width", "42px");
        logo.attr('src',logo.data('collapse')).css("margin-left", "-2px");
      }
    },
