...
$home_image = $db->assoc("SELECT * FROM home_images WHERE id = ?", [ $_REQUEST["home_image_id"]]);
...
if ($_REQUEST['type'] == "delete_home_image"){
    $db->delete("home_images", $home_image["id"]);
                            ...
                            <div class="card-block">
                                <form action="" method="POST" class="form"  enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control border-primary" placeholder="Nomi" id="name" value="<?=$home_image["name"]?>">
                                    </div>
