                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title" id="basic-layout-colored-form-control">Missiya qo'shish</h4>
                        ...
                        <div class="card-body collapse in">
                            <div class="card-block">
                                <form action="add_mission.php" method="POST" class="form" enctype="multipart/form-data">
                                    <input type="hidden" name="type" value="add_mission" required>
