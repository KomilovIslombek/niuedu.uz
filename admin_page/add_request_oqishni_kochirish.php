...
if ($_REQUEST['type'] == "add_request"){
    ...
    header("Location: requests_list.php?reg_type=oqishni-kochirish&page=1");
}
                    ...
                    <div class="card">
                        ...
                        <div class="card-body collapse in">
                            <div class="card-block">
                                <form action="add_request_oqishni_kochirish.php" method="POST" class="form" enctype="multipart/form-data">
