...
if ($_REQUEST['type'] == "add_post"){
    $name = isset($_REQUEST["name"]) ? $_REQUEST["name"] : null;
    if (!$name) {echo"post nomini kiritishni unutdingiz!";exit;}

    $html = isset($_REQUEST["html"]) ? $_REQUEST["html"] : null;
    if (!$html) {echo"postni kiritishni unutdingiz";exit;}
    ...
    header('Location: posts_list.php?page=1');
}
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title" id="basic-layout-colored-form-control">Post qo'shish</h4>
                        ...
                        <div class="card-body collapse in">
                            <div class="card-block">
                                <form action="add_post.php" method="POST" class="form" enctype="multipart/form-data">
                                    <input type="hidden" name="type" value="add_post" required>
                                    ...
                                    <? foreach ($db->in_array("SELECT * FROM langs_list") as $lang) { ?>
                                        <div class="form-group" form-lang="<?=$lang["flag_icon"]?>" style="<?=($lang["flag_icon"] != "uz" ? "display:none" : "")?>">
                                            ...
                                            <textarea name="name[<?=$lang["flag_icon"]?>]" class="form-control border-primary" placeholder="post nomi"></textarea>
                                        </div>
