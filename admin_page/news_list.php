                                        ...
                                        <?php
                                          ...
                                          foreach ($news as $news){
                                              ...
                                              echo '<tr>';
                                                  ...
                                                  echo '<td>'.lng($news['name'], "uz").'</td>';
                                                //   echo '<td>'.substr($news['mini_text'],0,30).'</td>';
                                                  echo '<td>'.$news['created_date'].'</td>';
                                                  echo '<td>';
                                                    echo '<a href="edit_news.php?news_id='.$news['id'].'&page='.$_REQUEST["page"].'" class="tag tag-default tag-warning text-white bg-success">tahrirlash</a>';
                                                  echo '</td>';
                                                  echo '<td>';
                                                    echo '<a href="edit_news.php?type=delete_news&news_id='.$news['id'].'&page='.$_REQUEST["page"].'" class="tag tag-default tag-warning text-white bg-danger">o`chirish</a>';
                                                echo '</td>';
                                              echo '</tr>';
                                          }
                                        ?>
