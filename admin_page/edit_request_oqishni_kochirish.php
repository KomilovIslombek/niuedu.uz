...
if ($_REQUEST['type'] == "change_course"){
    $db->update("requests", ["course_id" => $_REQUEST["course_id"]], ["id" => $request["id"]]);
    header("Location: requests_list.php?reg_type=".$request["reg_type"]."&page=".$_GET["page"]);
}
...
if ($_REQUEST['remove_payment'] == "1"){
    ...
    header("Location: requests_list.php" . ($_GET ? "?".http_build_query($_GET) : ""));
}
...
if ($_REQUEST['type'] == "edit_request"){
    ...
    header("Location: requests_list.php?reg_type=oqishni-kochirish&page=".$_GET["page"]);
}
                        ...
                        <div class="card-body collapse in">
                            <div class="card-block">
                                <form action="edit_request.php" method="POST" class="form" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label for="from_country_name">Qaysi davlatdan o'qishni ko'chirmoqchi</label>
                                        <input type="text" name="from_country_name" class="form-control border-primary" value="<?=$request["from_country_name"]?>" id="from_country_name">
                                    </div>

                                    <div class="form-group">
                                        <label for="from_university">Qaysi universitetdan o'qishni ko'chirmoqchi</label>
                                        <input type="text" name="from_university" class="form-control border-primary" value="<?=$request["from_university"]?>" id="from_university">
                                    </div>

                                    <div class="form-group">
                                        <label for="from_fakultet">Qaysi fakultetdan o'qishni ko'chirmoqchi</label>
                                        <input type="text" name="from_fakultet" class="form-control border-primary" value="<?=$request["from_fakultet"]?>" id="from_fakultet">
                                    </div>

                                    <div class="form-group">
                                        <label for="from_learn_type">Ta'lim shakli qanday?</label>
                                        <select name="from_learn_type" class="form-control">
                                            <option value="Kunduzgi" <?=($_POST["from_learn_type"] == "Kunduzgi" ? 'selected=""' : "")?>>Kunduzgi</option>
                                            <option value="Kechki" <?=($_POST["from_learn_type"] == "Kechki" ? 'selected=""' : "")?>>Kechki</option>
                                            <option value="Sirtqi" <?=($_POST["from_learn_type"] == "Sirtqi" ? 'selected=""' : "")?>>Sirtqi</option>
                                        </select>
                                    </div>

                                    <!--  -->
                                    <div class="form-group">
                                        <label for="from_course">Qaysi kursni tugatdingiz?</label>
                                        <select name="from_course" class="form-control">
                                            <option value="1-kurs" <?=($_POST["from_course"] == "1-kurs" ? 'selected=""' : "")?>>1-kurs</option>
                                            <option value="2-kurs" <?=($_POST["from_course"] == "2-kurs" ? 'selected=""' : "")?>>2-kurs</option>
                                            <option value="3-kurs" <?=($_POST["from_course"] == "3-kurs" ? 'selected=""' : "")?>>3-kurs</option>
                                            <option value="4-kurs" <?=($_POST["from_course"] == "4-kurs" ? 'selected=""' : "")?>>4-kurs</option>
                                        </select>
                                    </div>

                                    <div class="form-group">
                                        <label for="learn_type">Ta'lim shakli</label>
                                        <input type="text" name="learn_type" class="form-control border-primary" value="<?=$request["learn_type"]?>" id="learn_type">
                                    </div>

                                    <div class="form-group">
                                        <label for="to_university">Qaysi universitetga o'qishni ko'chirmoqchisiz?</label>
                                        <select name="to_university" class="form-control">
                                            <option value="NAVOIY INNOVATSIYALAR UNIVERSITETI">NAVOIY INNOVATSIYALAR UNIVERSITETI</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="to_course">Qaysi kursga o'tmoqchi</label>
                                        <input type="text" name="to_course" class="form-control border-primary" value="<?=$request["to_course"]?>" id="to_course">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="file_3">Transkript yoki akademik ma'lumotnoma</label>
