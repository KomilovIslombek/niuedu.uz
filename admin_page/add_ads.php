...
if ($_REQUEST['type'] == "add_ads"){
    $name = isset($_REQUEST['name']) ? $_REQUEST['name'] : null;
    if (!$name) {echo"e'lon nomini kiritishni unutdingiz!";exit;}

    $html = isset($_REQUEST['html']) ? $_REQUEST['html'] : null;
    if (!$html) {echo"e'lonni kiritishni unutdingiz";exit;}
    ...
    header('Location: ads_list.php?page=1');
}
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title" id="basic-layout-colored-form-control">E'lon qo'shish</h4>
                        ...
                        <div class="card-body collapse in">
                            <div class="card-block">
                                <form action="add_ads.php" method="POST" class="form" enctype="multipart/form-data">
                                    <input type="hidden" name="type" value="add_ads" required>
                                    ...
                                    <? foreach ($db->in_array("SELECT * FROM langs_list") as $lang) { ?>
                                        ...
                                        <div class="form-group" form-lang="<?=$lang["flag_icon"]?>" style="<?=($lang["flag_icon"] != "uz" ? "display:none" : "")?>">
                                            ...
                                            <textarea cols="80" name="html[<?=$lang["flag_icon"]?>]" rows="10" class="form-control border-primary" editor=""></textarea>
                                        </div>
                                    <? } ?>
